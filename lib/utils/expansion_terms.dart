...
/// The romanised-Hindi subset of [kExpansionTerms], marked explicitly.
///
/// The router needs to know when a query is transliterated, because embedding
/// models are trained on Devanagari and score romanised Hindi barely above
/// out-of-corpus noise. Inferring the subset as "an expansion key the corpus
/// never uses" looked elegant and was wrong: the guides mention `aag` once, so
/// a query of "aag" — fire — was not recognised as Hinglish and came within
/// 0.003 of being declined outright.
///
